 ...
 */
public class CustomListViewMainAdapter extends ArrayAdapter<RowItem_ListView_Main> {
    Context context;
    public CustomListViewMainAdapter(Context context, int resource, List<RowItem_ListView_Main> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        RowItem_ListView_Main rowitem = getItem(position);

        LayoutInflater mInflater = (LayoutInflater) context.getSystemService(Activity.LAYOUT_INFLATER_SERVICE);

        if(convertView == null){
            convertView = mInflater.inflate(R.layout.list_item_listview_main,null);
